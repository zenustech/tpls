...
//////////////////////////////////////////////////////////////////////////////
#include "zensim/tpls/umpire/strategy/mixins/Inspector.hpp"
...
Inspector::Inspector()
    : m_current_size(0), m_high_watermark(0), m_allocation_count{0}
{
}

void Inspector::registerAllocation(void* ptr, std::size_t size,
...
util::AllocationRecord Inspector::deregisterAllocation(
    void* ptr, strategy::AllocationStrategy* strategy)
{
  ...
  if (record.strategy == strategy) {
    ...
    ResourceManager::getInstance().registerAllocation(
        ptr, {ptr, record.size, record.strategy});
