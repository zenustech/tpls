...
#include "zensim/tpls/umpire/Allocator.hpp"
#include "zensim/tpls/umpire/resource/MemoryResourceTypes.hpp"
#include "zensim/tpls/umpire/strategy/AllocationStrategy.hpp"
#include "zensim/tpls/umpire/util/AllocationMap.hpp"
...
class ResourceManager {
 public:
   ...
   *
   * The Memory Resource Registry dynamically populates available memory
   * resource types based on what's available. This function returns those names
   * so they can be used to determine allocator accessibility.
   *
...
#include "zensim/tpls/umpire/ResourceManager.inl"
