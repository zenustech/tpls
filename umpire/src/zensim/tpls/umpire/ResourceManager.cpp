...
#include "zensim/tpls/umpire/Umpire.hpp"
...
#include "zensim/tpls/umpire/strategy/AllocationTracker.hpp"
#include "zensim/tpls/umpire/strategy/DynamicPool.hpp"
#include "zensim/tpls/umpire/strategy/FixedPool.hpp"
#include "zensim/tpls/umpire/strategy/ZeroByteHandler.hpp"
#if defined(UMPIRE_ENABLE_NUMA)
#include "zensim/tpls/umpire/strategy/NumaPolicy.hpp"
#endif
#include "zensim/tpls/umpire/util/MPI.hpp"
#include "zensim/tpls/umpire/util/Macros.hpp"
#include "zensim/tpls/umpire/util/io.hpp"
#include "zensim/tpls/umpire/util/make_unique.hpp"
#include "zensim/tpls/umpire/util/wrap_allocator.hpp"
...
void ResourceManager::addAlias(const std::string& name, Allocator allocator)
{
  if (isAllocator(name)) {
    ...
    UMPIRE_ERROR("Allocator " << name << " is already an alias for "
                              << ra.getName());
  }
...
void ResourceManager::removeAlias(const std::string& name, Allocator allocator)
{
  ...
  if (a->second->getId() != allocator.getId()) {
    UMPIRE_ERROR("Allocator " << name << " is not registered as an alias of "
                              << allocator.getName());
  }
