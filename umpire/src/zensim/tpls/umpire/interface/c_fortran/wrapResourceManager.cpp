...
umpire_allocator *umpire_resourcemanager_make_allocator_pool(
    ...
    size_t initial_size, size_t block, umpire_allocator *SHC_rv)
{
  umpire::ResourceManager *SH_this =
      static_cast<umpire::ResourceManager *>(self->addr);
    ...
    umpire_allocator *SHC_rv)
{
  umpire::ResourceManager *SH_this =
      static_cast<umpire::ResourceManager *>(self->addr);
  // splicer begin
  // class.ResourceManager.method.make_allocator_bufferify_list_pool
  const std::string SHCXX_name(name, Lname);
  umpire::Allocator *SHCXX_allocator =
      static_cast<umpire::Allocator *>(allocator.addr);
  umpire::Allocator *SHCXX_rv = new umpire::Allocator;
    ...
    umpire_allocator *SHC_rv)
{
  umpire::ResourceManager *SH_this =
      static_cast<umpire::ResourceManager *>(self->addr);
  // splicer begin
  // class.ResourceManager.method.make_allocator_bufferify_quick_pool
  const std::string SHCXX_name(name, Lname);
  umpire::Allocator *SHCXX_allocator =
      static_cast<umpire::Allocator *>(allocator.addr);
  umpire::Allocator *SHCXX_rv = new umpire::Allocator;
...
umpire_allocator *umpire_resourcemanager_make_allocator_advisor(
    umpire_resourcemanager *self, const char *name, umpire_allocator allocator,
    const char *advice_op, int device_id, umpire_allocator *SHC_rv)
{
  umpire::ResourceManager *SH_this =
      static_cast<umpire::ResourceManager *>(self->addr);
  ...
  umpire::Allocator *SHCXX_rv = new umpire::Allocator;
  *SHCXX_rv = SH_this->makeAllocator<umpire::strategy::AllocationAdvisor>(
    ...
    umpire_allocator *SHC_rv)
{
  ...
  umpire::Allocator *SHCXX_allocator =
      static_cast<umpire::Allocator *>(allocator.addr);
  umpire::Allocator *SHCXX_rv = new umpire::Allocator;
  *SHCXX_rv = SH_this->makeAllocator<umpire::strategy::NamedAllocationStrategy>(
    ...
    umpire_allocator *SHC_rv)
{
  ...
  umpire::Allocator *SHCXX_allocator =
      static_cast<umpire::Allocator *>(allocator.addr);
  umpire::Allocator *SHCXX_rv = new umpire::Allocator;
  *SHCXX_rv = SH_this->makeAllocator<umpire::strategy::ThreadSafeAllocator>(
      SHCXX_name, *SHCXX_allocator);
  SHC_rv->addr = SHCXX_rv;
  SHC_rv->idtor = 1;
  return SHC_rv;
    ...
    umpire_allocator allocator, umpire_allocator *SHC_rv)
{
  umpire::ResourceManager *SH_this =
      static_cast<umpire::ResourceManager *>(self->addr);
  // splicer begin
  // class.ResourceManager.method.make_allocator_bufferify_thread_safe
  const std::string SHCXX_name(name, Lname);
  umpire::Allocator *SHCXX_allocator =
      static_cast<umpire::Allocator *>(allocator.addr);
  umpire::Allocator *SHCXX_rv = new umpire::Allocator;
...
umpire_allocator *umpire_resourcemanager_make_allocator_fixed_pool(
    umpire_resourcemanager *self, const char *name, umpire_allocator allocator,
    size_t object_size, umpire_allocator *SHC_rv)
{
  umpire::ResourceManager *SH_this =
      static_cast<umpire::ResourceManager *>(self->addr);
...
umpire_allocator *umpire_resourcemanager_make_allocator_bufferify_fixed_pool(
    umpire_resourcemanager *self, const char *name, int Lname,
    umpire_allocator allocator, size_t object_size, umpire_allocator *SHC_rv)
{
  umpire::ResourceManager *SH_this =
      static_cast<umpire::ResourceManager *>(self->addr);
  // splicer begin
  // class.ResourceManager.method.make_allocator_bufferify_fixed_pool
  const std::string SHCXX_name(name, Lname);
  umpire::Allocator *SHCXX_allocator =
      static_cast<umpire::Allocator *>(allocator.addr);
  umpire::Allocator *SHCXX_rv = new umpire::Allocator;
    ...
    int device_id, umpire_allocator *SHC_rv)
{
  ...
  umpire::Allocator *SHCXX_allocator =
      static_cast<umpire::Allocator *>(allocator.addr);
  umpire::Allocator *SHCXX_rv = new umpire::Allocator;
  *SHCXX_rv = SH_this->makeAllocator<umpire::strategy::AllocationPrefetcher>(
...
umpire_allocator *umpire_resourcemanager_make_allocator_bufferify_prefetcher(
    umpire_resourcemanager *self, const char *name, int Lname,
    umpire_allocator allocator, int device_id, umpire_allocator *SHC_rv)
{
  umpire::ResourceManager *SH_this =
      static_cast<umpire::ResourceManager *>(self->addr);
  // splicer begin
...
void umpire_resourcemanager_register_allocator(umpire_resourcemanager *self,
                                               const char *name,
...
void umpire_resourcemanager_memset_all(umpire_resourcemanager *self, void *ptr,
                                       int val)
{
  umpire::ResourceManager *SH_this =
      static_cast<umpire::ResourceManager *>(self->addr);
...
void *umpire_resourcemanager_move(umpire_resourcemanager *self, void *src_ptr,
                                  umpire_allocator allocator)
{
  umpire::ResourceManager *SH_this =
      static_cast<umpire::ResourceManager *>(self->addr);
